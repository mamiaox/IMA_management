 ...
 * @author Albumen
 */
public class StaffManagePage extends Menu {
    @Override
    public int page(){
        Print.printWelcome(cn.albumenj.Application.loginedUserModel.getName());

        Print.printChoice("1、列出所有人员");
        Print.printChoice("2、查询指定人员");

        if(cn.albumenj.Application.loginedUserModel.isAdmin()){
            Print.printChoice("3、增加人员");
            Print.printChoice("4、删除人员");
            Print.printChoice("5、修改人员信息");
